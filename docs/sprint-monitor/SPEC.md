...
- hỗ trợ 3 run modes: light scan, deep analysis, endgame
...
## 16. Run modes
### 16.1 Light scan
Cadence: nhiều lần/ngày hoặc daily.

Mục tiêu:
- detect abnormality nhanh
- đa số run sẽ không gửi gì

### 16.2 Deep analysis
Cadence: T3/T5 hoặc 1–2 lần/tuần.

Mục tiêu:
- ra PM digest có judgment rõ
- dùng nhiều context hơn

### 16.3 Endgame
Cadence: cuối sprint + sau sprint.

Mục tiêu:
- salvage / descoping / carryover / retro insight
...
- owner nudge suppressed mặc định 24h
- lead alert suppressed đến khi severity tăng hoặc issue shape đổi
- PM digest có thể gửi mỗi deep-analysis run nhưng không lặp lại cùng wording vô ích
