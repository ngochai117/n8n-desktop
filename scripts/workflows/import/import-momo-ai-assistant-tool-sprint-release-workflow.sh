...
# SYNC_WORKFLOW_ID=uQ4zP7foDoysSCFn

ROOT_DIR="$(cd "$(dirname "$0")/../../.." && pwd)"
N8N_ENV_FILE="${1:-$ROOT_DIR/env.n8n.local}"
PROXY_ENV_FILE="${2:-$ROOT_DIR/env.proxy.local}"
WORKFLOW_TEMPLATE="${3:-$ROOT_DIR/workflows/ui-synced/MoMo/momo-ai-assistant-tool-sprint-release.workflow.json}"
...
WORKFLOW_REGISTRY_TEMPLATE="workflows/ui-synced/MoMo/momo-ai-assistant-tool-sprint-release.workflow.json" \
WORKFLOW_REGISTRY_IMPORT="scripts/workflows/import/import-momo-ai-assistant-tool-sprint-release-workflow.sh" \
