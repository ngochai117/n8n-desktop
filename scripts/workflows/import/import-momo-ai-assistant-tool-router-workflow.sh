...
# SYNC_WORKFLOW_ID=kY5dXvHgZDS3m92L

ROOT_DIR="$(cd "$(dirname "$0")/../../.." && pwd)"
N8N_ENV_FILE="${1:-$ROOT_DIR/env.n8n.local}"
PROXY_ENV_FILE="${2:-$ROOT_DIR/env.proxy.local}"
WORKFLOW_TEMPLATE="${3:-$ROOT_DIR/workflows/ui-synced/MoMo/momo-ai-assistant-tool-router.workflow.json}"
...
WORKFLOW_AUTO_ACTIVATE="true" \
WORKFLOW_REGISTRY_TEMPLATE="workflows/ui-synced/MoMo/momo-ai-assistant-tool-router.workflow.json" \
WORKFLOW_REGISTRY_IMPORT="scripts/workflows/import/import-momo-ai-assistant-tool-router-workflow.sh" \
