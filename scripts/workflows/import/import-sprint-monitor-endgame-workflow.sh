...
# SYNC_WORKFLOW_ID=mKJRp6UUBWXOTQDD
# SYNC_MANAGED_WRAPPER=1

ROOT_DIR="$(cd "$(dirname "$0")/../../.." && pwd)"
N8N_ENV_FILE="${1:-$ROOT_DIR/env.n8n.local}"
PROXY_ENV_FILE="${2:-$ROOT_DIR/env.proxy.local}"
WORKFLOW_TEMPLATE="${3:-$ROOT_DIR/workflows/sprint-monitor/sprint-monitor-endgame.workflow.json}"
...
WORKFLOW_REGISTRY_IMPORT="scripts/workflows/import/import-sprint-monitor-endgame-workflow.sh" \
